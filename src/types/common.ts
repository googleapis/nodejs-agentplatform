...
export declare interface SchemaPredictParamsGroundingConfigSourceEntry {
...
export declare interface SchemaPredictParamsGroundingConfig {
...
export declare interface SchemaPromptInstancePromptExecution {
  ...
  arguments?: Record<string, SchemaPromptInstanceVariableValue>;
}

/** Represents a prompt message. */
export declare interface SchemaPromptSpecPromptMessage {
  /** Generation config. */
  generationConfig?: genaiTypes.GenerationConfig;
  /** Tool config. This config is shared for all tools provided in the request. */
  toolConfig?: genaiTypes.FunctionCallingConfig;
  ...
  systemInstruction?: genaiTypes.Content;
  variables?: Record<string, genaiTypes.Part>[];
  /** The model name. */
  model?: string;
}

/** Prompt variation that embeds preambles to prompt string. */
export declare interface SchemaPromptSpecMultimodalPrompt {
  /** The prompt message. */
  promptMessage?: SchemaPromptSpecPromptMessage;
}
...
export declare interface SchemaPromptSpecStructuredPrompt {
  /** Preamble: The context of the prompt. */
  context?: genaiTypes.Content;
  /** Data for app builder use case. */
  appBuilderData?: SchemaPromptSpecAppBuilderData;
  /** Preamble: A set of examples for expected model response. */
  examples?: SchemaPromptSpecPartList[];
  ...
  predictionInputs?: SchemaPromptSpecPartList[];
  /** The prompt message. */
  promptMessage?: SchemaPromptSpecPromptMessage;
  /** Data for interaction use case. */
  interactionData?: SchemaPromptSpecInteractionData;
}

/** A pair of sentences used as reference in source and target languages. */
export declare interface SchemaPromptSpecReferenceSentencePair {
...
export declare interface SchemaPromptSpecReferenceSentencePairList {
  /** Reference sentence pairs. */
  referenceSentencePairs?: SchemaPromptSpecReferenceSentencePair[];
}
...
export declare interface SchemaPromptSpecTranslationGcsInputSource {
  /** Source data URI. For example, `gs://my_bucket/my_object`. */
  inputUri?: string;
}

export declare interface SchemaPromptSpecTranslationSentenceFileInput {
  /** Inlined file source. */
  fileInputSource?: SchemaPromptSpecTranslationFileInputSource;
  /** Cloud Storage file source. */
  gcsInputSource?: SchemaPromptSpecTranslationGcsInputSource;
}

/** The translation example that contains reference sentences from various sources. */
export declare interface SchemaPromptSpecTranslationExample {
  /** The reference sentences from inline text. */
  referenceSentencePairLists?: SchemaPromptSpecReferenceSentencePairList[];
  /** The reference sentences from file. */
  referenceSentencesFileInputs?: SchemaPromptSpecTranslationSentenceFileInput[];
}

/** Optional settings for translation prompt. */
export declare interface SchemaPromptSpecTranslationOption {
  /** How many shots to use. */
  numberOfShots?: number;
}

/** Prompt variation for Translation use case. */
export declare interface SchemaPromptSpecTranslationPrompt {
  /** The translation example. */
  example?: SchemaPromptSpecTranslationExample;
  /** The translation option. */
  option?: SchemaPromptSpecTranslationOption;
  /** The prompt message. */
  promptMessage?: SchemaPromptSpecPromptMessage;
...
export declare interface SchemaPromptApiSchema {
...
export declare interface SchemaTextPromptDatasetMetadata {
  ...
  promptApiSchema?: SchemaPromptApiSchema;
...
export declare interface CreateDatasetConfig {
  /** Used to override HTTP request options. */
  httpOptions?: genaiTypes.HttpOptions;
  /** Abort signal which can be used to cancel the request.
...
export declare interface CreateDatasetParameters {
  name?: string;
  displayName?: string;
  metadataSchemaUri?: string;
  metadata?: SchemaTextPromptDatasetMetadata;
  description?: string;
  encryptionSpec?: genaiTypes.EncryptionSpec;
...
export declare interface CreateDatasetVersionConfig {
  /** Used to override HTTP request options. */
  httpOptions?: genaiTypes.HttpOptions;
  /** Abort signal which can be used to cancel the request.
...
export declare interface CreateDatasetVersionParameters {
  datasetName?: string;
  metadata?: SchemaTextPromptDatasetMetadata;
  modelReference?: string;
  parent?: string;
  displayName?: string;
  config?: CreateDatasetVersionConfig;
}

/** Parameters for getting a dataset resource to store prompts. */
export declare interface GetDatasetParameters {
  name?: string;
  config?: VertexBaseConfig;
}
...
/** Parameters for getting a dataset resource to store prompts. */
export declare interface GetDatasetVersionParameters {
  datasetId?: string;
...
export declare interface DatasetVersion {
...
export declare interface GetDatasetOperationConfig {
  /** Used to override HTTP request options. */
  httpOptions?: genaiTypes.HttpOptions;
  /** Abort signal which can be used to cancel the request.
...
export declare interface GetDatasetOperationParameters {
  datasetId?: string;
  operationId?: string;
  config?: GetDatasetOperationConfig;
}

/** Config for listing prompt datasets and dataset versions. */
export declare interface ListPromptsConfig {
  /** Used to override HTTP request options. */
  httpOptions?: genaiTypes.HttpOptions;
  /** Abort signal which can be used to cancel the request.
...
export declare interface ListDatasetsRequestParameters {
  config?: ListPromptsConfig;
}

/** Response for listing prompt datasets. */
export class ListDatasetsResponse {
  /** Used to retain the full HTTP response. */
  sdkHttpResponse?: genaiTypes.HttpResponse;
  nextPageToken?: string;
...
export declare interface ListDatasetVersionsRequestParameters {
  readMask?: string;
  datasetId?: string;
  config?: ListPromptsConfig;
}
...
export declare interface DeletePromptConfig {
  /** Used to override HTTP request options. */
  httpOptions?: genaiTypes.HttpOptions;
  /** Abort signal which can be used to cancel the request.
...
export declare interface DeleteDatasetRequestParameters {
  /** ID of the prompt dataset to be deleted. */
  promptId: string;
  config?: DeletePromptConfig;
}

/** Operation for deleting prompts. */
export declare interface DeletePromptOperation {
  /** The server-assigned name, which is only unique within the same service that originally returns it. If you use the default HTTP mapping, the `name` should be a resource name ending with `operations/{unique_id}`. */
  name?: string;
  /** Service-specific metadata associated with the operation. It typically contains progress information and common metadata such as create time. Some services might not provide such metadata.  Any method that returns a long-running operation should document the metadata type, if any. */
  metadata?: Record<string, unknown>;
...
export declare interface DeletePromptVersionRequestParameters {
...
export declare interface DeletePromptVersionOperation {
  /** The server-assigned name, which is only unique within the same service that originally returns it. If you use the default HTTP mapping, the `name` should be a resource name ending with `operations/{unique_id}`. */
  name?: string;
  /** Service-specific metadata associated with the operation. It typically contains progress information and common metadata such as create time. Some services might not provide such metadata.  Any method that returns a long-running operation should document the metadata type, if any. */
  metadata?: Record<string, unknown>;
...
export declare interface RestoreVersionConfig {
  /** Used to override HTTP request options. */
  httpOptions?: genaiTypes.HttpOptions;
  /** Abort signal which can be used to cancel the request.
...
export declare interface RestoreVersionRequestParameters {
  /** ID of the prompt dataset to be restored. */
  datasetId: string;
  /** ID of the prompt dataset version to be restored. */
  versionId: string;
  config?: RestoreVersionConfig;
}

/** Represents the restore version operation. */
export declare interface RestoreVersionOperation {
  /** The server-assigned name, which is only unique within the same service that originally returns it. If you use the default HTTP mapping, the `name` should be a resource name ending with `operations/{unique_id}`. */
  name?: string;
  /** Service-specific metadata associated with the operation. It typically contains progress information and common metadata such as create time. Some services might not provide such metadata.  Any method that returns a long-running operation should document the metadata type, if any. */
  metadata?: Record<string, unknown>;
...
/** Config for creating a dataset resource to store prompts. */
export declare interface UpdatePromptConfig {
  /** Used to override HTTP request options. */
  httpOptions?: genaiTypes.HttpOptions;
  /** Abort signal which can be used to cancel the request.
...
/** Parameters for creating a dataset resource to store prompts. */
export declare interface UpdateDatasetParameters {
  name?: string;
  datasetId?: string;
  displayName?: string;
  metadata?: SchemaTextPromptDatasetMetadata;
...
export type PromptData = SchemaPromptSpecPromptMessage;
...
export declare interface CreatePromptVersionConfig {
  /** Used to override HTTP request options. */
  httpOptions?: genaiTypes.HttpOptions;
  /** Abort signal which can be used to cancel the request.
...
export declare interface GetPromptConfig {
  /** Used to override HTTP request options. */
  httpOptions?: genaiTypes.HttpOptions;
  /** Abort signal which can be used to cancel the request.
...
export declare interface PromptRef {
  promptId?: string;
  model?: string;
}

/** Reference to a prompt version. */
export declare interface PromptVersionRef {
  promptId?: string;
  versionId?: string;
  model?: string;
}
